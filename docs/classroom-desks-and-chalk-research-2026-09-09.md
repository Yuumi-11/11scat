...
后续状态：用户已否定本文偏写实的整页插画，选定 CHAWP 并同意英文日期，当前要求见[固定材质、台历卡片与粉笔交互](classroom-flat-style-2026-09-09.md)。本文保留前轮字体调研证据，不再将 Chalk-S 作为实施推荐；中文任务与自由笔画见[最新手写字体与粉笔验证](handwriting-and-freehand-chalk-2026-09-09.md)，不沿用本文仅针对日期汉字的覆盖判断。
