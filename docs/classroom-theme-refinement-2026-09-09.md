...
后续版本：用户已进一步要求取消顶栏并改为实体课桌布局，当前方案见[课桌布局与粉笔字体复调研](classroom-desks-and-chalk-research-2026-09-09.md)。本文记录前一版九处批注的设计示意，沿用现有网站文案与功能；本次交付外观方案和可点按的投影布动画示意，尚未修改网站界面。教室方向已经确定，人物卡片的最终位置仍在讨论。
