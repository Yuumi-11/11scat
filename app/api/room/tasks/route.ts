...
import { CollaborationError, CollaborationStore } from "./store";
import { gateway } from "./provider";

export const runtime = "nodejs";
const store = new CollaborationStore(process.env.DATA_DIR || (process.env.NODE_ENV === "production" ? "/data" : path.join(process.cwd(), ".data")), gateway);
