...
export function ProjectionSample() {
  ...
  useEffect(() => {
    ...
    let frame = 0;
    const draw = () => {
      context.fillStyle = '#dce4dd'; context.fillRect(0, 0, 1280, 800);
      ...
      context.strokeStyle = '#6c9384'; context.lineWidth = 7; context.beginPath();
