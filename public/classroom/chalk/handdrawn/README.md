...
2026-09-11 第五版更新：猫咪在保留参考图基本造型的基础上，增加耳朵和脸颊处的轻微折角，以不等长的笔画和局部接笔表现徒手轮廓，身体下沿减少连续圆弧。气球继续使用自然倾角和前后遮挡，绳线调整为接近气球边缘的笔画宽度，轮廓与涂色中的粉笔颗粒也更明显。两款的 PNG 和 WebP 已一同更新，文件地址沿用原路径。
